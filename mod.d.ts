...
/**
* Interface for generating beta prime distributed pseudorandom numbers with pre-specified parameter values.
*/
...
/**
* Interface for generating beta prime distributed pseudorandom numbers without pre-specified parameter values.
*/
...
interface Random extends PRNG {
	...
	*
	* @example
	* var mybetaprime = betaprime.factory( 1.5, 1.5 );
	*
	* var v = mybetaprime();
	* // returns <number>
	*
	* @example
	* var mybetaprime = betaprime.factory( 2.0, 3.0, {
	*     'seed': 297
	* });
	* var v = mybetaprime();
	* // returns <number>
	...
	*
	* @example
	* var mybetaprime = betaprime.factory();
	*
	* var v = mybetaprime( 1.5, 1.5 );
	* // returns <number>
	*
	* @example
	* var mybetaprime = betaprime.factory({
