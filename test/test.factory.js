...
tape( 'attached to the returned function is the generator name', function test( t ) {
	...
	t.strictEqual( betaprime.NAME, 'betaprime', 'has property' );
	t.end();
});

tape( 'attached to the returned function is the underlying PRNG', function test( t ) {
	var betaprime = factory();
	t.strictEqual( typeof betaprime.PRNG, 'function', 'has property' );

	betaprime = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.PRNG, minstd.normalized, 'has property' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed (integer seed)', function test( t ) {
	...
	t.strictEqual( isUint32Array( betaprime.seed ), true, 'has property' );
	t.strictEqual( betaprime.seed[ 0 ], 12345, 'equal to provided seed' );

	betaprime = factory({
		'seed': 12345,
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.seed, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed length', function test( t ) {
	var betaprime = factory();
	t.strictEqual( typeof betaprime.seedLength, 'number', 'has property' );

	betaprime = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.seedLength, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state', function test( t ) {
	var betaprime = factory();
	t.strictEqual( isUint32Array( betaprime.state ), true, 'has property' );

	betaprime = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.state, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state length', function test( t ) {
	var betaprime = factory();
	t.strictEqual( typeof betaprime.stateLength, 'number', 'has property' );

	betaprime = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.stateLength, null, 'equal to `null`' );
	t.end();
});

tape( 'attached to the returned function is the generator state size', function test( t ) {
	var betaprime = factory();
	t.strictEqual( typeof betaprime.byteLength, 'number', 'has property' );

	betaprime = factory({
		'prng': minstd.normalized
	});
	t.strictEqual( betaprime.byteLength, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is a method to serialize the generator as a JSON object', function test( t ) {
	...
	betaprime = factory();
	t.strictEqual( typeof betaprime.toJSON, 'function', 'has method' );

	o = betaprime.toJSON();
	t.strictEqual( o.type, 'PRNG', 'has property' );
	t.strictEqual( o.name, betaprime.NAME, 'has property' );
	...
	t.strictEqual( typeof betaprime.toJSON, 'function', 'has method' );
	t.strictEqual( betaprime.toJSON(), null, 'returns expected value' );
...
tape( 'the function supports specifying the generator state', function test( t ) {
	...
	for ( i = 0; i < 100; i++ ) {
		t.strictEqual( betaprime(), arr[ i ], 'returns expected value. i: '+i+'.' );
	}
	t.end();
});
